...
const MeEn = () => {
  ...
  return (
    ...
    <p>
    Passionate about development and technology, I'm looking for new opportunities to enrich my experience. I'm currently working on some small personal projects.
    </p>
    <p>
