...
const MeFr = () => {
  ...
  return (
    ...
    <p>
      Passionné par le développement et la technologie, je suis à la recherche de nouvelles opportunités pour enrichir mon expérience. Actuellement, sur des petits projets personnels.
    </p>
    <p> 
